...
const Contact = () => {
    return (
        <div className="w-full relative">
            <img src={ContactBack} className="object-cover w-full h-96" />
            <div className="absolute left-1/2 top-1/2 tranform -translate-y-1/2 -translate-x-1/2 w-max flex items-center justify-center top-0 cursor-pointer group ">
